...
public class Controller {
    ...
    private PedidoMediator mediador = new PedidoConcreteMediator();
    ...
    private void crearPedido() {
        ...
        mediador.seleccionarCliente(nombreCliente);
    ...
    private void agregarProducto() {
        if (mediador.resumenPedido().equals("No hay pedido creado.")) {
        ...
        mediador.agregarProducto(nombreProducto);
    ...
    private void quitarProducto() {
        ...
        // Acceder directamente al pedido para quitar producto usando estado interno
        Pedido pedido = ((PedidoConcreteMediator) mediador).getPedido();
        if (pedido != null) {
            pedido.quitarProducto(productoSeleccionado);
        }
        refrescarListaProductos();
    ...
    private void refrescarListaProductos() {
        Pedido pedido = ((PedidoConcreteMediator) mediador).getPedido();
        if (pedido != null) {
            productosObservable.setAll(pedido.getProductos());
        } else {
            productosObservable.clear();
        }
    }
